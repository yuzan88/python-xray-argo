...
UUID = os.environ.get('UUID', '4492faf4-18ed-4820-967f-63313572bd78')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', '1.nezha.us.ci:80')        # 哪吒面板域名或ip, v1格式: nezha.xxx.com:8008, v0格式: nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')            # v1哪吒请留空, v0哪吒的agent通信端口,自动匹配tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'WJ3d2083Mpbx1cXQlzLUmzP1p19eoPad')              # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
